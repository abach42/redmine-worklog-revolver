...
public class TimeRangeYesterdayProductTest {
    public TimeRangeInterface subject = mock(TimeRangeYesterdayProduct.class, 
    withSettings()
    ...
    */
    ...
    private static final int ACTUAL_DAY = 6;
    ...
    @Test
    public void testGetFromIsYesterday() {
        LocalDate expected = LocalDate.of(ACTUAL_YEAR, ACTUAL_MONTH, ACTUAL_DAY-1);
        subject.setFrom();
