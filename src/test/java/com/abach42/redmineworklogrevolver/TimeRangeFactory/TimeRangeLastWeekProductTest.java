...
public class TimeRangeLastWeekProductTest {
    public TimeRangeInterface subject = mock(TimeRangeLastWeekProduct.class, 
        withSettings()
    ...
    */
    ...
    @Test
    @DisplayName("Begin of some last week")
    ...
    @Test
    @DisplayName("End of some last week")
    public void testSetTo() {
        LocalDate expected = LocalDate.of(ACTUAL_YEAR, ACTUAL_MONTH, 11);
        subject.setTo();
